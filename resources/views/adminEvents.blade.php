                  ...
                  <div class="modal-body">
                    <div class="infos">
                      <form action="">
                        ...
                        <input class="cep" type="text" id="cep" name="cep" data-js="cep" placeholder="CEP">
                        <input class="road" type="text" id="road" name="road" placeholder="Logradouro" disabled>
                        <input class="district" type="text" id="district" name="district" placeholder="Bairro" disabled>
